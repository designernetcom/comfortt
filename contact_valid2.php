...
if($error=="")
{
      ...
      //  $mail->Port = 587;                                    // TCP port to connect to
        ...
        $message_body.="<tr><td>Contact's Full Name : </td><td>".$_POST['name2']."</td></tr>";
        $message_body.="<tr><td>Contact's Email : </td><td>".$_POST['email2']."</td></tr>";
        $message_body.="<tr><td>Contact's Number : </td><td>".$_POST['phone2']."</td></tr>";
        
        $message_body.="<tr><td>Contact's Message : </td><td>".$_POST['message2']."</td></tr>";
       ...
       // $mail->AddAttachment( $_FILES['file']['tmp_name'], $_FILES['file']['name'] );
        $mail->Subject  = 'Comfort Care Company New User';
        $mail->isHTML(true);
